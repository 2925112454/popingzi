...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        if (options.autocomplete) {
            ...
            if ($.fn.textcomplete) {
                ...
                $.getScript("../style/emoji/jquery.textcomplete.js",
                    autocomplete);
            }
        }
    ...
    var cdn = { 
		defaultBase: "/style/emoji/",//https://cdnjs.cloudflare.com/ajax/libs/emojione/
		base: null,
		isLoading: false
	};
    function loadEmojione(options) {
		...
		if (!cdn.isLoading) {
			if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
				cdn.isLoading = true;
				$.getScript(cdn.defaultBase + emojioneVersion + "/emojione.min.js", function () { ///lib/js/emojione.min.js
