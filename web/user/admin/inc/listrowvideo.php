<?php
if ($adminyeslist===200 && ($allvip==4||$allvip==3||$allvip==2)  && !is_null($ppzusername) && $rlit_if==3){
...
if(mysqli_num_rows($linkretvalyb) >= 0){
     ...
     echo '<script type="text/javascript">var listfllinkid="'.$listfllinkid.'";var listflid="'.$rlit_fl.'";var videoarr="'.$rlit_text.'";var rowid="'.$listid.'"</script>';
     echo '<script src="/style/js/select.js" type="text/javascript"></script><script src="/style/js/editarrvideo.js" type="text/javascript"></script>';
}
}else{
    echo "请勿胡搞！";
}
