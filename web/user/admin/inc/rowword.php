<?php
if ($admin==1 && $typeuser==12 && ($allvip==4||$allvip==3||$allvip==2)  && !is_null($ppzusername) && $typeyes==1){
echo '<div class="user-h1"><span><i class="fa fa-plus-circle"></i>发布图文</span><a href="?type=12"><i class="fa fa-angle-double-left" aria-hidden="true"></i>返回类型</a></div>';
echo '
<div class="newword">
...
echo '</select>
        ...
        <div class="newword-title">
        <span class="letter1em">下载：</span>
        <div class="rowdowdiv"><input type="text" name="rowdow" id="rowdow" maxlength="9" value="0"/><span class="spanfloat">积分</span></div>
    ...
    <script src="/style/js/rowform.js" type="text/javascript"></script>
</div>';
echo '
