/*
 ...
 Source Server Version : 50000
 Source Host           : localhost:3306
 Source Schema         : popingzi

 Target Server Type    : MySQL
 Target Server Version : 50000
 File Encoding         : 65001
...
) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '充值卡配置信息';
...
CREATE TABLE `ppz_codeset` (
  ...
  `setrmb` bigint NOT NULL DEFAULT 0 COMMENT '邀请码获取价格',
...
CREATE TABLE `ppz_commentary` (
  `plid` bigint NOT NULL AUTO_INCREMENT COMMENT '评论id',
  ...
  `plrowid` bigint NULL DEFAULT NULL COMMENT '评论所属文章id',
  `pladmin` bigint NULL DEFAULT 1 COMMENT '评论发布者id',
...
CREATE TABLE `ppz_folus` (
  `usid` bigint NOT NULL AUTO_INCREMENT COMMENT '关注id',
  `usuename` bigint NULL DEFAULT NULL COMMENT '被关注者id',
  `usvip` bigint NULL DEFAULT NULL COMMENT '关注者id',
...
CREATE TABLE `ppz_letter` (
  `terid` bigint NOT NULL AUTO_INCREMENT COMMENT '私信id',
  `tertext` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '私信内容',
  `teradmin` bigint NULL DEFAULT NULL COMMENT '私信发送者',
  `teruser` bigint NULL DEFAULT 0 COMMENT '私信接收人，0为所有人',
...
CREATE TABLE `ppz_log` (
  `logid` bigint NOT NULL AUTO_INCREMENT COMMENT '交易记录id',
  `logadmin` bigint NULL DEFAULT NULL COMMENT '交易会员ID',
  ...
  `logrowid` bigint NULL DEFAULT NULL COMMENT '交易产生文章ID',
...
CREATE TABLE `ppz_newusername` (
  ...
  `uusername` bigint NULL DEFAULT NULL COMMENT '账号',
  ...
  `ugold` bigint NULL DEFAULT 0 COMMENT '积分',
...
CREATE TABLE `ppz_reply` (
  `repid` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `repplid` bigint NULL DEFAULT NULL COMMENT '评论id',
  `repadmin` bigint NULL DEFAULT NULL COMMENT '回复者id',
  `reptext` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回复内容',
  `reptime` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '回复时间',
  `repip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回复ip地址',
  PRIMARY KEY (`repid`) USING BTREE
...
CREATE TABLE `ppz_row` (
  `rowid` bigint NOT NULL AUTO_INCREMENT COMMENT '文章id',
  ...
  `rowadmin` bigint NULL DEFAULT 1 COMMENT '发表人',
  ...
  `rowsc` bigint NULL DEFAULT 0 COMMENT '收藏数',
...
CREATE TABLE `ppz_subcomm` (
  `comm_id` bigint NOT NULL AUTO_INCREMENT COMMENT '话题评论ID',
  `comm_subid` bigint NULL DEFAULT NULL COMMENT '评论所属话题的ID',
  `comm_type` bigint NULL DEFAULT 0 COMMENT '评论类型，0为父评论，大于0则为对应父评论的回复',
  `comm_yes` int(11) NULL DEFAULT 0 COMMENT '回复是否已读，0为未读，1为已读',
  `comm_admin` bigint NULL DEFAULT NULL COMMENT '评论者ID',
...
CREATE TABLE `ppz_subject` (
  ...
  `admin` bigint NULL DEFAULT NULL COMMENT '发表人ID',
  ...
  `eyes` bigint NULL DEFAULT 0 COMMENT '话题阅览量',
...
CREATE TABLE `ppz_vtime` (
  `vid` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
CREATE TABLE `ppz_work` (
  ...
  `wkadmin` bigint NULL DEFAULT NULL COMMENT '提交工单的会员id',
...
-- ----------------------------
-- Function structure for REGEXP_REPLACE (适配MySQL5.0)
-- ----------------------------
