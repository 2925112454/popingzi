...
if (!isPositiveInteger($id)||empty($name)) {
    outputError(500);
}
$id = (int)$id;
$name = htmlspecialchars($name);
// ========== 查询ID是否存在 ==========
$comm_sql = "SELECT sub_id,sub_name FROM ppz_subtype WHERE sub_id = ?";
...
// ========== 修改 ==========
$sql = "UPDATE ppz_subtype SET sub_name = ? WHERE sub_id = ?";
